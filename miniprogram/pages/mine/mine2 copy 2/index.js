...
Page({
  ...
  onClickA: function (e) {
    ...
    Api.queryCircle('lxy_contact/queryCircle.action',{
      ...
      LinkMemberID: e.currentTarget.dataset.index,
      //LikeType: 1,
      ...
      if(JSON.parse(res.data).Records){
        ...
        console.log(res)
          ...
          // console.log(that.data.con[e.currentTarget.dataset.index2])

          // that.data.con.splice(that.data.con[e.currentTarget.dataset.index2],1)
        ...
        Api.addCircle('lxy_contact/addCircle.action',{
          ...
          LinkRemarks: e.currentTarget.dataset.item,
          BusinessID: getApp().globalData.BusinessID
        }).then(res=>{
          console.log(res)
        })
  ...
  blacklist(e){
    ...
    Api.queryCircle('lxy_contact/queryCircle.action',{
      MemberID: wx.getStorageSync('MemberID'),
      LinkMemberID: that.data.con1.MemberID,
      //LikeType: 1,
      BusinessID: getApp().globalData.BusinessID
    }).then(res=>{
      console.log(res)
        ...
        Api.queryCircle('lxy_contact/queryCircle.action',{
          ...
          if(!JSON.parse(res.data).Records){
            Api.addCircle('lxy_contact/addCircle.action',{
              ...
              LikeType: 2,
              MemRemarks: wx.getStorageSync('nickName'),
              LinkRemarks: that.data.con1.MemberName2,
              BusinessID: getApp().globalData.BusinessID
            }).then(res=>{
              console.log(res)
            })
	  ...
	  console.log(that.data.con[this.data.con2])
 
      that.data.con.splice(this.data.con2,1)
